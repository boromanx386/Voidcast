...
export default {
  ...
  theme: {
    extend: {
      colors: {
        void: {
          black: 'rgb(var(--color-void-black) / <alpha-value>)',
          dark: 'rgb(var(--color-void-dark) / <alpha-value>)',
          mid: 'rgb(var(--color-void-mid) / <alpha-value>)',
          muted: 'rgb(var(--color-void-muted) / <alpha-value>)',
          dim: 'rgb(var(--color-void-dim) / <alpha-value>)',
          text: 'rgb(var(--color-void-text) / <alpha-value>)',
          light: 'rgb(var(--color-void-light) / <alpha-value>)',
          white: 'rgb(var(--color-void-white) / <alpha-value>)',
        },
        neon: {
          cyan: 'rgb(var(--color-neon-cyan) / <alpha-value>)',
          'cyan-dim': 'rgb(var(--color-neon-cyan-dim) / <alpha-value>)',
          magenta: 'rgb(var(--color-neon-magenta) / <alpha-value>)',
          'magenta-dim': 'rgb(var(--color-neon-magenta-dim) / <alpha-value>)',
          green: 'rgb(var(--color-neon-green) / <alpha-value>)',
          'green-dim': 'rgb(var(--color-neon-green-dim) / <alpha-value>)',
        ...
        glitch: {
          ...
          blue: 'rgb(var(--color-glitch-blue) / <alpha-value>)',
          green: 'rgb(var(--color-glitch-green) / <alpha-value>)',
        }
      },
      fontFamily: {
